...
public:
	...
	void setScrollerImageUp (ofImage* img) { scrollerUpImage = img; }
	void setScrollerImageDown (ofImage* img) { scrollerDownImage = img; }
	
	void setItemBGUp (ofImage* img) { itemBGUp = img; }
	void setItemBGDown (ofImage* img) { itemBGDown = img; }
	
	void setBackgroundImage (ofImage* img ) { backgroundImage = img; }
...
protected:
	...
	ofImage *scrollerUpImage, *scrollerDownImage, *itemBGUp, *itemBGDown, *backgroundImage;
